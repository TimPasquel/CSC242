...
--------------------------------------------------------------------------------
select distinct first_name from grade_report where last_name="Hatfield" order by first_name asc;
...
--------------------------------------------------------------------------------
select category, grade_item, grade from grade_report where first_name="Gil" and last_name="Yates" and course="CSC136" and category="exam" order by grade_item;
--------------------------------------------------------------------------------
SELECT '
Question 4:';
-- Write a query to return the exam 2 grades in CSC253 030 in descending order.
--------------------------------------------------------------------------------
select grade from grade_report where category="exam" and grade_item=2 and course="CSC253" and section="030" order by grade desc;
...
--------------------------------------------------------------------------------
select count(distinct student_id) from grade_report;
...
--------------------------------------------------------------------------------
select distinct first_name, last_name from grade_report where course="CSC242" and section="010" and grade>=90.0 and category="homework" and grade_item=1 order by last_name asc;
...
--------------------------------------------------------------------------------
select count(distinct student_id) from grade_report where course="CSC223" order by student_id asc;
...
--------------------------------------------------------------------------------
select avg(grade) from grade_report where first_name="Inez" and last_name="Wilder" and category="exam";
...
--------------------------------------------------------------------------------
select distinct first_name, last_name from grade_report where grade>=60.0 and category="exam" and grade_item=1 and course="CSC242" and section="010" order by last_name asc;
...
--------------------------------------------------------------------------------
select min(grade) from grade_report where category="homework" and course="CSC125" and section="010";
...
-- CSC135.
--------------------------------------------------------------------------------
select avg(grade) from grade_report where category="exam" and grade_item=1 and course="CSC135";
...
--------------------------------------------------------------------------------
select distinct first_name, last_name from grade_report where last_name like 'D%' order by last_name asc;
...
--------------------------------------------------------------------------------
select count(distinct grade_item) from grade_report where category="homework" and course="CSC136" and section="020";
...
--------------------------------------------------------------------------------
select count(distinct section) from grade_report where course="CSC135";
...
-- by first name.
--------------------------------------------------------------------------------
select distinct first_name from grade_report where first_name like 'O%' or first_name like '%o' order by first_name asc;
...
--------------------------------------------------------------------------------
select distinct first_name, last_name from grade_report where course="CSC125" and section="010" order by last_name desc;
...
--------------------------------------------------------------------------------
select max(grade) from grade_report where first_name="Jarvis" and last_name="Leach";
...
--------------------------------------------------------------------------------
select count(distinct student_id) from grade_report where grade<60.0;
...
-- is less than 60)
--------------------------------------------------------------------------------
select distinct first_name, last_name from grade_report where grade_item=1 and category="exam" and course="CSC242" and section="010" and grade<60.0 order by last_name asc;
...
--------------------------------------------------------------------------------
select min(grade), max(grade), avg(grade) from grade_report where category="quiz" and course="CSC135";
